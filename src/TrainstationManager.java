...
public class TrainstationManager {
    ...
    public static Trainstation huemme = new Trainstation("Hümme",3,"Haltestelle");
    public static Trainstation oberkaka = new Trainstation("Oberkaka",4,"Bahnhof");
    public static Trainstation unterkaka = new Trainstation("Unterkaka",2,"Haltepunkt");
    public static Trainstation rixen = new Trainstation("Rixen",4,"Bahnhof");
    ...
    public static Trainstation erfurt = new Trainstation("Erfurt",4,"Bahnhof");
    public static Trainstation querfurt = new Trainstation("Querfurt",3,"Bahnhof");
    public static Trainstation[] stationlist = new Trainstation[]{grabsleben,huemme,rixen,oberkaka,unterndorf,unterkaka,oberstdorf,erfurt,querfurt};
